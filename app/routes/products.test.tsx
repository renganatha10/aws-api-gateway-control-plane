...
const products = [
  { id: 1, displayName: "Petstore Bundle", name: "petstore", visibility: "public", createdAt: new Date() },
  { id: 2, displayName: "Internal APIs", name: "internal", visibility: "authenticated", createdAt: new Date() },
]
