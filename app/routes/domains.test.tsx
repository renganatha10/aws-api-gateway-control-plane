...
const domains = [
  { id: 1, domainName: "api.example.com", endpointType: "REGIONAL", awsDomainName: "d-abc.execute-api.amazonaws.com", mappingCount: 2, createdAt: new Date() },
  { id: 2, domainName: "api2.example.com", endpointType: "EDGE", awsDomainName: null, mappingCount: 0, createdAt: new Date() },
]
...
describe("DomainsPage route", () => {
  ...
  it("renders New Domain link", () => {
    render(<DomainsPage />)
    expect(screen.getByRole("link", { name: "New Domain" })).toHaveAttribute("href", "/domains/new")
  })
})
