...
describe("Login route", () => {
  ...
  it("shows error message from actionData", () => {
    render(<Login loaderData={{ mode: "login" }} actionData={{ error: "Invalid credentials", mode: "login" }} as any />)
  ...
  it("renders Sign Up link tab", () => {
    render(<Login {...loginProps} />)
    expect(screen.getByRole("link", { name: "Sign Up" })).toHaveAttribute("href", "/login?mode=signup")
  })
})
