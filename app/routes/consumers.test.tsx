...
const consumers = [
  { id: 1, name: "mobile-app", productName: "Petstore", environmentName: "prod", planName: "gold", createdAt: new Date() },
  { id: 2, name: "web-app", productName: "Stores", environmentName: "staging", planName: "silver", createdAt: new Date() },
]
...
describe("ConsumersPage route", () => {
  ...
  it("renders New Consumer button", () => {
    render(<ConsumersPage />)
    expect(screen.getByRole("link", { name: "New Consumer" })).toHaveAttribute("href", "/consumers/new")
  })
})
