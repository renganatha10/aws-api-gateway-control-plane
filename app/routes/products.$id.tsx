...
export async function loader({ request, params }: Route.LoaderArgs) {
  ...
  const [associatedApis, associatedPlans, allApis, allPlans] = await Promise.all([
  ...
  return { product, associatedApis, associatedPlans, allApis, allPlans, email, gatewayId }
}
...
type Section = "Product setup" | "Visibility" | "APIs" | "Plans"
const LEFT_NAV: Section[] = ["Product setup", "Visibility", "APIs", "Plans"]
...
export default function ProductDetailPage() {
  const { product, associatedApis, associatedPlans, allApis, allPlans } =
