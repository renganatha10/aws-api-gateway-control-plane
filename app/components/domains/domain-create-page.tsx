...
export function DomainCreatePage({ apis, certs, actionError, submitting }: DomainCreatePageProps) {
  ...
  const primaryRegion = certs.find((c) => c.region !== "ap-south-1")?.region ?? "";
        ...
        <div className="flex flex-col gap-6 px-6 py-6 max-w-2xl">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Regional: cert must be in the same region as your organisation. Edge: cert must be in
              ap-south-1.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">
              Your GoDaddy root domain. When set, the CNAME record for this custom domain is created
              automatically after provisioning.
            </p>
          </div>
