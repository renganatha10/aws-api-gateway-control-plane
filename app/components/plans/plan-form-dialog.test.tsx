...
describe("PlanFormDialog", () => {
  ...
  it("shows Edit Plan title when editing a plan", () => {
    const plan: Plan = {
      id: 1, displayName: "Gold", name: "gold", organisationId: 1,
      throttle: null, burst: null, quotaLimit: null, quotaPeriod: null,
      createdBy: "admin", updatedBy: null, awsUsagePlanId: null,
  ...
  it("shows 'Save changes' button when editing", () => {
    const plan: Plan = {
      id: 2, displayName: "Silver", name: "silver", organisationId: 1,
      throttle: 50, burst: 100, quotaLimit: null, quotaPeriod: null,
      createdBy: "admin", updatedBy: null, awsUsagePlanId: null,
      createdAt: new Date(), updatedAt: new Date(),
    }
    render(<PlanFormDialog {...defaultProps} editingPlan={plan} />)
