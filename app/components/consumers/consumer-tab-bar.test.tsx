...
describe("ConsumerTabBar", () => {
  ...
  it("renders Details as plain span (active) and Try Out as link when activeTab=details", () => {
    ...
    expect(screen.getByRole("link", { name: "Try Out" })).toHaveAttribute("href", "/consumers/5/tryout")
  })
  ...
  it("uses the correct consumer ID in links", () => {
    ...
    expect(screen.getByRole("link", { name: "Try Out" })).toHaveAttribute("href", "/consumers/99/tryout")
  })
})
