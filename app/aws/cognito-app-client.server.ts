...
export async function deleteAppClient(userPoolId: string, clientId: string): Promise<void> {
...
export async function getClientSecret(userPoolId: string, clientId: string): Promise<string> {
  const result = await cognitoClient.send(
